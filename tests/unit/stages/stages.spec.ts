    ...
    describe('#getStages', () => {
      describe('#HappyPath', () => {
        it('should return array with single stage formatted object by criteria', async function () {
          ...
          const { status: stageOperationStatus, job_id: jobId, name: type, xstate, ...rest } = stageEntity;
          const expectedStage = [{ stageOperationStatus, ...rest }];
    ...
    describe('#getStageById', () => {
      describe('#HappyPath', () => {
        it('should return stage object by provided id', async function () {
          ...
          const { status: stageOperationStatus, job_id: jobId, name: type, xstate, ...rest } = stageEntity;
          const expectedStage = { stageOperationStatus, jobId, ...rest };
