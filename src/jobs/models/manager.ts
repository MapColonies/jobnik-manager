...
import { errorMessages as commonErrorMessages, prismaKnownErrors } from '@common/errors';
...
export class JobManager {
  ...
  public async updateStatus(jobId: string, status: JobOperationStatus, tx?: PrismaTransaction): Promise<void> {
    ...
    if (!isValidStatus) {
      throw new IllegalJobStatusTransitionError(commonErrorMessages.invalidStatusTransition);
    }
