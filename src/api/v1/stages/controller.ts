...
import { StageManager } from '../../../stages/models/manager';
import type { StageFindCriteriaArg } from '../../../stages/models/models';
...
export class StageControllerV1 {
  ...
  public getStages: TypedRequestHandlers['GET /v1/stages'] = async (req, res, next) => {
  ...
  public getStageById: TypedRequestHandlers['GET /v1/stages/{stageId}'] = async (req, res, next) => {
    try {
  ...
  public getStagesByJobId: TypedRequestHandlers['GET /v1/jobs/{jobId}/stages'] = async (req, res, next) => {
    try {
  ...
  public addStage: TypedRequestHandlers['POST /v1/jobs/{jobId}/stage'] = async (req, res, next) => {
    try {
  ...
  public getSummaryByStageId: TypedRequestHandlers['GET /v1/stages/{stageId}/summary'] = async (req, res, next) => {
    try {
  ...
  public updateUserMetadata: TypedRequestHandlers['PATCH /v1/stages/{stageId}/user-metadata'] = async (req, res, next) => {
    try {
  ...
  public updateStatus: TypedRequestHandlers['PUT /v1/stages/{stageId}/status'] = async (req, res, next) => {
    try {
