 ...
 * @returns StageModel
 */
export function convertPrismaToStageResponse(prismaObjects: Prisma.StageGetPayload<Record<string, never>>): StageModel {
 ...
 */
export function convertArrayPrismaStageToStageResponse(prismaObjects: Prisma.StageGetPayload<Record<string, never>>[]): StageModel[] {
